function SecondProductListWindow (_args) {
    ...
    breadcrumbLabel = Ti.UI.createLabel({
        ...
        color: '#000',
        text: String.format(L('product_text'),item.product)
    }),
    ...
    self.addEventListener('open', function (e) {
        ...
        shopProductService.all(_.pick(item, 'product_id')).done(function (result) {
            var tableRows = [];
...
module.exports = SecondProductListWindow;